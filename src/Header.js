...
function Header(){
    ...
    <span>
    <Button variant="contained" href="https://drive.google.com/file/d/1_jdvxcFw0utx2O35l2XXjxNmqzQXBj6h/view?usp=sharing" target='_blank' rel="noopener noreferrer" className="button">
  Resume
</Button>
    </span>
        </div>
